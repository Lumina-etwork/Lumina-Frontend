...
export default function OfflinePage() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-background px-6 py-12 text-foreground">
      <div className="w-full max-w-xl rounded-lg border border-border bg-surface p-8 text-center shadow-sm">
        ...
        <OfflineBanner />
        <ol className="mt-6 list-decimal space-y-2 pl-5 text-left text-sm text-muted-text">
